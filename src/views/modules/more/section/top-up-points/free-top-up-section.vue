<template>
  <q-card class="bg-grey-1" style="border: 1px solid #9e9e9e">
    <q-card-section class="text-center">
      <div class="text-h6">{{ $t("more.freeTopUpSection.option1") }}</div>
      <div class="text-subtitle1">{{ $t("more.freeTopUpSection.freeTopUpPoints") }}</div>

      <div class="text-body2 q-mt-md text-justify">
        <!-- {{ $t("more.freeTopUpSection.freeTopUpSection", { topUpPoints }) }} -->
        {{
          $t("more.freeTopUpSection.claim", {
            points: topUpPoints
          })
        }}
      </div>
