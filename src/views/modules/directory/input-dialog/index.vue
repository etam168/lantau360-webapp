  ...
  >
    <q-card class="bg-white">
      <q-layout view="hHh lpR fFf">
        <app-dialog-bar :barTitle="$t('directory.dialoge.create')" />
        <q-page-container>
...
<script setup lang="ts">
  ...
  const previewDirectory = ref<DirectoryInput>({} as DirectoryInput);
  const imagePath = ref<any>();

  provide("previewDirectory", previewDirectory);
  ...
  onMounted(() => {
    eventBus.on("CloseDirectoryDilaog", () => {
