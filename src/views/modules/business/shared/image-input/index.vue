    ...
    <q-item>
      <q-item-section>
        <image-input
          ...
          label="Listing Image"
          :img-source="businessImages.listingImage?.imagePath"
        />
      </q-item-section>
      ...
      <q-item-section>
        <image-input
          ...
          label="Feature Image"
          :img-source="businessImages.featureImage?.imagePath"
        />
      </q-item-section>
    </q-item>
  </q-list> -->
...
<script setup lang="ts">
  ...
  //   businessImages.value.featureImage = {
  ...
  //   businessImages.value.listingImage = {
  //     imagePath: URL.createObjectURL(image),
  //     image: image
  //   };
