    ...
    <template #default>
      <q-card flat class="q-mt-md">
        <q-list>
          ...
          <q-item>
            <q-item-section>
              <q-item-label>{{ $t("business.columns.contactOther") }}</q-item-label>
            </q-item-section>
          ...
          <q-item>
            <q-item-section>
              <q-item-label>{{ $t("business.columns.contactPhone") }}</q-item-label>
            </q-item-section>
          ...
          <q-item>
            <q-item-section>
              <q-item-label>{{ $t("business.columns.contactWhatsApp") }}</q-item-label>
            </q-item-section>
...
<script setup lang="ts">
  ...
  const previewData = inject("previewData") as Ref<BusinessInput>;
