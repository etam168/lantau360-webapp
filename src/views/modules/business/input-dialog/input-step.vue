...
<script setup lang="ts">
  ...
  const { businessImages, setValidateInput, createBusiness } = useBusinessInput();
  ...
  //git commit -m "fix preview data of newly created building in business dialog"
  ...
  onMounted(() => {
    businessImage.value = businessImages.value;
