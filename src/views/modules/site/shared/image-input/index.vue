    ...
    <q-item>
      <q-item-section>
        <image-input
          ...
          label="Listing Image"
          :img-source="siteImages.listingImage?.imagePath"
        />
      </q-item-section>
      ...
      <q-item-section>
        <image-input
          ...
          label="Feature Image"
          :img-source="siteImages.featureImage?.imagePath"
        />
      </q-item-section>
    </q-item>
  </q-list> -->
...
<script setup lang="ts">
  ...
  const siteImages = inject("images") as Ref<SiteImages>;
