      ...
      <q-page-container>
        ...
        <Suspense>
          <template #default>
            ...
            <community-detail-content :community :entity-key />
          </template>
          <template #fallback>
...
<script setup lang="ts">
  ...
  const dialogTitle = computed(() => {
    const nameKey = "directoryName" as keyof DirectoryTypes;

    return entityKey === "COMMUNITY_DIRECTORY" && community
      ? translate(community[nameKey] as string, community.meta, nameKey)
      : ""; // Default or alternative value if category is undefined or condition is not met
  });
